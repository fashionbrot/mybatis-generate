...
public class FileUtil {
    ...
    public static String getUserHome(String fileName) {
        return USER_HOME + File.separator + GlobalConst.NAME + File.separator + fileName + File.separator;
    }
    ...
    public static String getFileContent(File file) {
        ...
        try {
            ...
            while ((randomAccessFile.read(buf)) != -1) {
                sb.append(new String(buf, GlobalConst.ENCODE_UTF8));
                buf = new byte[1024];
            }
    ...
    public static void writeFile(File file, String content) {
        ...
        try {
            ...
            randomAccessFile.write(content.getBytes(GlobalConst.ENCODE_UTF8));
        } catch (Exception e) {
            log.error("writeFile error", e);
        } finally {
